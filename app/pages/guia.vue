    ...
    <div class="container mx-auto px-4 lg:px-8">
      <header class="mb-10">
        ...
        >
          ...
          <ul class="ml-4 list-inside list-disc text-sm">
            ...
            <li>
              Equipamiento tecnológico de última generación y exención de
              restricciones de circulación.
            </li>
            <li>Contribuir activamente a la protección del medio ambiente.</li>
          </ul>
        </div>
      </header>
      ...
      <div class="mb-10 rounded-lg bg-gray-100 p-5">
        ...
        <p class="text-gray-700">
          En mayo de 2025, Chile marcó un precedente histórico cuando los
          vehículos eléctricos e híbridos alcanzaron el
          <strong>10% del total de ventas automotrices del año</strong> (Fuente
          ANAC). Esto representa un salto desde el 4% en 2023 y el 7% en 2024,
          señalando que el país está entrando en una nueva fase hacia la
      ...
      >
        Tipos de Vehículos: Conoce todas las opciones disponibles
      </h2>
      ...
      <div class="mb-10 grid gap-8 md:grid-cols-2">
        <div class="rounded-lg border border-gray-200 p-6 shadow-sm">
          <h3 class="text-primary mb-2 text-xl font-semibold">
            BEV - Vehículo 100% Eléctrico (Battery Electric Vehicle)
          </h3>
          <p class="mb-3 text-gray-600">
            La opción más limpia del mercado (<em>cero emisiones</em>). Funciona
            exclusivamente con energía eléctrica almacenada en baterías.
          </p>
          <ul class="list-inside list-disc space-y-1 text-sm text-gray-700">
            <li>
              <strong>Autonomía típica:</strong> 250-500 km por carga completa.
            </li>
            <li>
              <strong>Ideal para:</strong> usuarios con acceso a carga
              domiciliaria y trayectos urbanos o interurbanos planificables.
            </li>
            <li>
              <strong>Marcas destacadas:</strong> Tesla, BYD, Volvo y BMW.
            </li>
          </ul>
        </div>
        ...
        <div class="rounded-lg border border-gray-200 p-6 shadow-sm">
          ...
          <p class="mb-3 text-gray-600">
            Combina motor eléctrico para trayectos cortos y motor de combustión
            para viajes largos.
          </p>
          <ul class="list-inside list-disc space-y-1 text-sm text-gray-700">
            <li>
              <strong>Autonomía eléctrica:</strong> 40-80 km en modo eléctrico.
            </li>
            <li>
              <strong>Ideal para:</strong> trayectos diarios cortos y viajes
              ocasionales.
            </li>
            <li>
              <strong>Marcas destacadas:</strong> Mitsubishi, Volvo, Toyota.
            </li>
          </ul>
        </div>
        ...
        <div class="rounded-lg border border-gray-200 p-6 shadow-sm">
          <h3 class="text-primary mb-2 text-xl font-semibold">
            HEV - Híbrido Convencional (Hybrid Electric Vehicle)
          </h3>
          <p class="mb-3 text-gray-600">
            Motor de combustión asistido por motor eléctrico. Batería se recarga
            mediante frenado regenerativo.
          </p>
          <ul class="list-inside list-disc space-y-1 text-sm text-gray-700">
            <li>
              <strong>Ventaja principal:</strong> reducción del consumo de
              combustible en ciudad.
            </li>
            <li>
              <strong>Ideal para:</strong> conductores que buscan eficiencia sin
              cambiar hábitos de abastecimiento.
            </li>
            <li><strong>Marcas destacadas:</strong> Toyota, Kia, Honda.</li>
          </ul>
        </div>

        <div class="rounded-lg border border-gray-200 p-6 shadow-sm">
          <h3 class="text-primary mb-2 text-xl font-semibold">
            MHEV - Microhíbrido o Híbrido Suave (Mild Hybrid Electric Vehicle)
          </h3>
          <p class="mb-3 text-gray-600">
            Motor eléctrico que asiste al motor de combustión en arranques y
            aceleraciones.
          </p>
          <ul class="list-inside list-disc space-y-1 text-sm text-gray-700">
            <li>
              <strong>Ventaja principal:</strong> mejora eficiencia de
              combustible con mínimos cambios de manejo.
            </li>
            <li>
              <strong>Ideal para:</strong> quienes buscan eficiencia sin alterar
      ...
      <div
        class="mb-10 rounded-lg border border-gray-200 bg-gray-50 p-4 shadow-sm"
      >
        <h3 class="text-primary mb-2 text-xl font-semibold">
          EREV - Eléctrico con Extensor de Rango (Extended Range Electric
          Vehicle)
        </h3>
        <p class="text-gray-600">
          Funciona como eléctrico puro con respaldo de combustión para generar
          electricidad adicional. Disponibilidad limitada, no recomendado para
          casos generales.
        </p>
      </div>
      ...
      <div class="my-10 text-center">
        <img
          src="https://storage.googleapis.com/tendenciasmedia/Tabla%20Guia%20AutoVolt"
          alt="Tabla Guía AutoVolt de comparación de vehículos"
          class="mx-auto h-auto max-w-full rounded-lg border border-gray-300"
          style="width: 70%"
        />
        <p class="mt-2 text-sm text-gray-500">Tabla Guía AutoVolt</p>
      </div>

      <h2
        class="mt-10 mb-6 border-b-2 border-gray-200 pb-2 text-3xl font-bold text-gray-800"
      >
      ...
      <div class="mt-12 border-t border-gray-200 pt-6 text-center">
        <h2 class="mb-4 text-2xl font-bold text-gray-800">
          Elige tu próximo vehículo con AutoVolt
        </h2>
        <p class="mb-6 text-lg text-gray-600">
          AutoVolt pone a tu disposición el catálogo completo de vehículos
          eléctricos e híbridos del mercado chileno, con herramientas de
          comparación y simuladores de ahorro.
        </p>
        <NuxtLink
          to="/autos-electricos"
          class="btn btn-lg btn-primary text-nowrap"
        >
          Explora autos eléctricos e híbridos en AutoVolt
        </NuxtLink>
      </div>
    </div>
  </section>
